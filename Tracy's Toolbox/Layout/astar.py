...
layout = [ 
    [sg.Text('Please enter your  Start/End Coords')], 
    [sg.Text('Start Xcoord', size =(15, 1)), sg.InputText()], 
    [sg.Text('Start Ycoord', size =(15, 1)), sg.InputText()], 
    [sg.Text('End Xcoord', size =(15, 1)), sg.InputText()], 
    [sg.Text('End Ycoord', size =(15, 1)), sg.InputText()], 
    [sg.Submit(), sg.Cancel()] 
] 
...
print(event, startx, starty, endx , endy)

diagram4 = GridWithWeights(35, 30)
...
for x in range(12, 20):
   for y in range(3,25):
       diagram4.walls += [(x,x), (x,y), (x,y), (x, x), (y, y), (y, x), (x,x)]
#############################  End Testing ##################################################
